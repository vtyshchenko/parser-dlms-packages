...
import threading
import traceback
import component.gurux_common.io.BaudRate
import component.gurux_common.io.Parity
import component.gurux_common.io.StopBits
from component.gurux_common.enums import TraceLevel, MediaState, TraceTypes
from component.gurux_common.IGXMedia import IGXMedia
from component.gurux_common.MediaStateEventArgs import MediaStateEventArgs
from component. gurux_common.TraceEventArgs import TraceEventArgs
from component.gurux_common.PropertyChangedEventArgs import PropertyChangedEventArgs
from component.gurux_common.ReceiveEventArgs import ReceiveEventArgs
from ._GXSynchronousMediaBase import _GXSynchronousMediaBase
from .. import gurux_common
...
class GXSerial(IGXMedia):
    def __init__(self,
                 ...
                 dataBits=7,
                 parity=gurux_common.io.Parity.EVEN,
        ...
        ###Trace level.
        self.__trace = TraceLevel.VERBOSE
        ###End of packet.
        self.__eop = None
        self.__listeners = []
