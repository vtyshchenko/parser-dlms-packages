...
class GXDLMSProfileGeneric(GXDLMSObject, IGXDLMSBase):
    ...
    def __init__(self, ln=None, sn=0):
        ...
        self.len_data = 0
        self.len_buf = 0
        self.selective_acc_caption_obj = None
    ...
    def __setBuffer(self, settings, e):
        ...
        if cols is None:
            ...
            cols = self.captureObjects if self.selective_acc_caption_obj is None else self.selective_acc_caption_obj
